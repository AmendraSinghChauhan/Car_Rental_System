    ...
    public void menu() {
        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                System.out.println("\n== Return a  Car==\n");
                System.out.println("EnterThe car ID you want to return:");
                String carid = scanner.nextLine();
                ...
                if (cartoreturn != null) {
                    ...
                    System.out.println("Invalid car ID or is not rented");
                }
...
CarRentalSyatem rentalSyatem = new CarRentalSyatem();
Car car1 = new Car("C001","toyota","Camry",90.9);
Car car2 = new Car("C002","Bmw","Camry",10.0);
rentalSyatem.addCar(car1);
rentalSyatem.addCar(car2);
